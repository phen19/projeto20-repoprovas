...
import { emptyFields, emptyFieldsSignIn, invalidJoiValidation, invalidJoiValidationSignIn, validData } from "./factories/authFactory"

beforeEach(async () =>{
    const consulta:any = await prisma.$executeRaw`SELECT * FROM users`
